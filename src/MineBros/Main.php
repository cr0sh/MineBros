...
//TODO: random skill shuffling in startGame(), /mi command
  ...
  public function onCommand(CommandSender $sender, Command $command, $label, array $args){
    ...
    switch($args[0]){
      case 'help':
        ...
        $sender->sendMessage(self::HEAD_MBROS.'능력 쿨타임: '.TextFormat::AQUA.$ch->getCooldown().'초');
        return true;
        break;
  ...
  public function startGame(){
    if($this->status){
      $this->getLogger()->emergency("FATAL ERROR: Game started while game is already running");
